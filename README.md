...
<body>  
  <!-- matrix canvas -->  
  <canvas id="matrix"></canvas>    <main class="container" role="main" aria-labelledby="title">  
    <!-- LEFT: Hero -->  
    <section class="hero" aria-labelledby="title">  
      ...
      </div>  <h1><span class="glow">Coming</span> <span>Soon</span></h1>  
...
</html>  Isme se Countdown ka section remove kar do
