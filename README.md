    ...
    function handleChat(event) {
        if (event.key === 'Enter') {
            ...
            const keywordResponses = [
                ...
                { keywords: ["about", "founder", "who is", "what is","af", "academeforge"], response: "AcademeForge is an educational platform founded by Devraj Kumar and co-founded by Mandeep." }, 
